...
func recursiveFlatMap<T, TResult>(_ root: T, transform: (T) -> TResult?, children: (T) -> [T]) -> [TResult]
{
	var result = [TResult]()
...
///breadth-first
func  firstRecursiveDescendent<T>(_ root: T, children: (T) -> [T], filter: (T) -> Bool) -> T?
{
